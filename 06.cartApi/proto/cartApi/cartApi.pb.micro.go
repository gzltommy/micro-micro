...
type CartApiService interface {
	FindAll(ctx context.Context, in *imports.Request, opts ...client.CallOption) (*imports.Response, error)
}
...
func (c *cartApiService) FindAll(ctx context.Context, in *imports.Request, opts ...client.CallOption) (*imports.Response, error) {
...
type CartApiHandler interface {
	FindAll(context.Context, *imports.Request, *imports.Response) error
}

func RegisterCartApiHandler(s server.Server, hdlr CartApiHandler, opts ...server.HandlerOption) error {
	type cartApi interface {
		FindAll(ctx context.Context, in *imports.Request, out *imports.Response) error
	}
	type CartApi struct {
		cartApi
	}
...
func (h *cartApiHandler) FindAll(ctx context.Context, in *imports.Request, out *imports.Response) error {
